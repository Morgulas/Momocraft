...
public class MMC_BlockFloating extends Block
{

    public MMC_BlockFloating(int i, int j, boolean flag)
    {
    ...
    private void tryToFall(World world, int i, int j, int k)
    {
        ...
        if(canFallAbove(world, l, i1 + 1, j1) && i1 < 128)
        {
            ...
            {
                MMC_EntityFloatingBlock entityfloatingblock = new MMC_EntityFloatingBlock(world, (float)i + 0.5F, (float)j + 0.5F, (float)k + 0.5F, blockID);
