...
public class BlockAetherEnchanter extends BlockContainer{
	
    public BlockAetherEnchanter(int i)
    {
        super(i, Material.rock);
        blockIndexInTexture = MomocraftTextures.TexBlockAetherEnchanterTop;
        sideTexture = MomocraftTextures.TexBlockAetherEnchanterTop;
