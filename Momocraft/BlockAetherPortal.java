...
public class BlockAetherPortal extends BlockBreakable{
	 ...
	 public BlockAetherPortal(int i, int j)
	    {
	    ...
	    public void transmuteWaterToPortal(World world, int i, int j, int k)
	    {
	        ...
	        world.setBlockWithNotify(l + 0, j, i1 + 0, MomocraftBlocks.BlockAetherPortal.blockID);
	        world.setBlockWithNotify(l + 1, j, i1 + 0, MomocraftBlocks.BlockAetherPortal.blockID);
	        world.setBlockWithNotify(l + 1, j, i1 + 1, MomocraftBlocks.BlockAetherPortal.blockID);
	        world.setBlockWithNotify(l + 0, j, i1 + 1, MomocraftBlocks.BlockAetherPortal.blockID);
