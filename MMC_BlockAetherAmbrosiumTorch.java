...
public class MMC_BlockAetherAmbrosiumTorch extends Block{
	
	public MMC_BlockAetherAmbrosiumTorch(int i)
    {
        super(i, MMC_Textures.TexBlockAetherAmbrosiumTorch, Material.circuits);
        setTickOnLoad(true);
    }
    ...
    public void onNeighborBlockChange(World world, int i, int j, int k, int l)
    {
        if(dropTorchIfCantStay(world, i, j, k))
        {
            ...
            if(flag)
            {
                dropBlockAsItem(world, i, j, k, world.getBlockMetadata(i, j, k), i1);
