...
////////////////////////////////////////////////////////////        
	        if(l == 41){
	            return renderBlockHerse(block, i, j, k);
	        }else
	        if(l == 18)
	        {
//	        	if(block.blockID == MC_0ID.bVitre)
//	        	{
//	        		return renderpanecolor((BlockPane)block, i, j, k);
//	        	} else
//	        	{
...
//	        	}
	        ...
	        if(l == 51)
	        {
	        	return renderBlockCouverts(block, i, j, k);
	        }
	        if(l == 53)
	        {
	            return renderBlockHoublon(block, i, j, k);
	        }
	        if(l == 35)
	        {
	        	return renderBlockChaine(block, i, j, k);
	        }
	        if(l == 70)
	        {
	        	return renderBlockArche(block, i, j, k);	        	
	        }
	        if(l == 10)
	        {
	            return renderBlockCoinStair(block, i, j, k);
	        }
	        if(l == 73)
	        {
	        	return renderpanecolor((BlockPane)block, i, j, k);
	        ...
	        if(l == 71)
	        {
	        	return renderBlockMuret(block, i, j, k);	        	
	        }
        	if(l == 52)
        	{
                return renderBlockTonneau(block, i, j, k);
            }else
//////////////////////////////////////////////////////////////
    ...
    public boolean renderBlockCauldron(BlockCauldron blockcauldron, int i, int j, int k)
    {
        ...
        char c = '\232';
        float f5 = 0.125F;
        renderSouthFace(blockcauldron, ((float)i - 1.0F) + f5, j, k, c);
        renderNorthFace(blockcauldron, ((float)i + 1.0F) - f5, j, k, c);
        renderWestFace(blockcauldron, i, j, ((float)k - 1.0F) + f5, c);
        renderEastFace(blockcauldron, i, j, ((float)k + 1.0F) - f5, c);
        char c1 = '\213';
    ...
    public boolean renderBlockFluids(Block block, int i, int j, int k)
    {
        ...
        for(int k1 = 0; k1 < 4; k1++)
        {
            ...
            if(renderAllFaces || aflag[k1])
            {
                ...
                tessellator.setBrightness(block.getMixedBrightnessForBlock(blockAccess, j2, j, i2));
                float f10 = 1.0F;
                if(k1 < 2)
                {
                    f10 *= f5;
    ...
    public boolean renderStandardBlock(Block block, int i, int j, int k)
    {
        ...
        return !Minecraft.isAmbientOcclusionEnabled() || Block.lightValue[block.blockID] != 0 ? renderStandardBlockWithColorMultiplier(block, i, j, k, f, f1, f2) : renderStandardBlockWithAmbientOcclusion(block, i, j, k, f, f1, f2);
    }
...
//Herse
            if(k == 41){
                ...
                block.setBlockBounds(0.45F, 0.0F, 0.2F, 0.55F, 1.0F, 0.3F);
                renderStandartInInventory(block, i);
                block.setBlockBounds(0.45F, 0.0F, 0.7F, 0.55F, 1.0F, 0.8F);
                renderStandartInInventory(block, i);
                block.setBlockBounds(0.475F, 0.225F, 0.0F, 0.525F, 0.275F, 0.2F);
                renderStandartInInventory(block, i);
                block.setBlockBounds(0.475F, 0.225F, 0.3F, 0.525F, 0.275F, 0.7F);
                renderStandartInInventory(block, i);
                block.setBlockBounds(0.475F, 0.225F, 0.8F, 0.525F, 0.275F, 1.0F);
                renderStandartInInventory(block, i);
                block.setBlockBounds(0.475F, 0.725F, 0.0F, 0.525F, 0.775F, 0.2F);
                renderStandartInInventory(block, i);
                block.setBlockBounds(0.475F, 0.725F, 0.3F, 0.525F, 0.775F, 0.7F);
                renderStandartInInventory(block, i);
                block.setBlockBounds(0.475F, 0.725F, 0.8F, 0.525F, 0.775F, 1.0F);
                renderStandartInInventory(block, i);
                block.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);            	
            }
            if(k == 73){
...
//Tonneau
			if(k == 52){
	            ...
	            block.setBlockBounds(0.05F, 0.0F, 0.05F, 0.95F, 1.0F, 0.15F);
	            renderStandartInInventory(block, i);
	            block.setBlockBounds(0.05F, 0.0F, 0.85F, 0.95F, 1.0F, 0.95F);
	            renderStandartInInventory(block, i);
	            block.setBlockBounds(0.05F, 0.0F, 0.15F, 0.15F, 1.0F, 0.85F);
	            renderStandartInInventory(block, i);
	            block.setBlockBounds(0.85F, 0.0F, 0.15F, 0.95F, 1.0F, 0.85F);
	            renderStandartInInventory(block, i);
	            block.setBlockBounds(0.15F, 0.8F, 0.15F, 0.85F, 0.9F, 0.85F);
	            renderStandartInInventory(block, i);
	            block.setBlockBounds(0.0F, 0.6F, 0.05F, 0.05F, 0.75F, 0.95F);
	            renderStandartInInventoryByTextureId(block, i, 22);
	            block.setBlockBounds(0.95F, 0.6F, 0.05F, 1.0F, 0.75F, 0.95F);
	            renderStandartInInventoryByTextureId(block, i, 22);
	            block.setBlockBounds(0.0F, 0.6F, 0.0F, 1.0F, 0.75F, 0.05F);
	            renderStandartInInventoryByTextureId(block, i, 22);
	            block.setBlockBounds(0.0F, 0.6F, 0.95F, 1.0F, 0.75F, 1.0F);
	            renderStandartInInventoryByTextureId(block, i, 22);
	            block.setBlockBounds(0.0F, 0.25F, 0.05F, 0.05F, 0.4F, 0.95F);
	            renderStandartInInventoryByTextureId(block, i, 22);
	            block.setBlockBounds(0.95F, 0.25F, 0.05F, 1.0F, 0.4F, 0.95F);
	            renderStandartInInventoryByTextureId(block, i, 22);
	            block.setBlockBounds(0.0F, 0.25F, 0.0F, 1.0F, 0.4F, 0.05F);
	            renderStandartInInventoryByTextureId(block, i, 22);
	            block.setBlockBounds(0.0F, 0.25F, 0.95F, 1.0F, 0.4F, 1.0F);
	            renderStandartInInventoryByTextureId(block, i, 22);
	            block.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
			}else
    ...
    public static boolean renderItemIn3d(int i)
    {
        ...
        return i != 0 ? i != 13 ? i != 10 ? i != 11 ? i != 27 ? i != 22 ? i != 21 ? i != 52 ? i != 41 ? i != 70 ? i != 71 ? ModLoader.RenderBlockIsItemFull3D(i) : true : true : true : true : true : true : true : true : true : true : true;
    }

    
    
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public void renderStandartInInventory(Block block, int i)
    {
        Tessellator tessellator = Tessellator.instance;
        block.setBlockBoundsForItemRender();
        GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
    ...
    public void renderStandartInInventoryByTextureId(Block block, int i, int j)
    {
        Tessellator tessellator = Tessellator.instance;
        block.setBlockBoundsForItemRender();
        GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, -1F, 0.0F);
        renderBottomFace(block, 0.0D, 0.0D, 0.0D, j);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 1.0F, 0.0F);
        renderTopFace(block, 0.0D, 0.0D, 0.0D, j);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 0.0F, -1F);
        renderEastFace(block, 0.0D, 0.0D, 0.0D, j);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 0.0F, 1.0F);
        renderWestFace(block, 0.0D, 0.0D, 0.0D, j);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(-1F, 0.0F, 0.0F);
        renderNorthFace(block, 0.0D, 0.0D, 0.0D, j);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(1.0F, 0.0F, 0.0F);
        renderSouthFace(block, 0.0D, 0.0D, 0.0D, j);
        tessellator.draw();
        GL11.glTranslatef(0.5F, 0.5F, 0.5F);
    }
    
    public boolean renderStandartByTextureId(Block block, int i, int j, int k, int l)
    {
        int i1 = block.colorMultiplier(blockAccess, i, j, k);
        ...
        {
            return renderStandardBlockWithAmbientOcclusionByTextureId(block, i, j, k, f, f1, f2, l);
        } else
        {
            return renderStandardBlockWithColorMultiplierByTextureId(block, i, j, k, f, f1, f2, l);
        }
    }
    
    public boolean renderStandardBlockWithAmbientOcclusionByTextureId(Block block, int i, int j, int k, float f, float f1, float f2, 
            int l)
    {
        enableAO = true;
        boolean flag = false;
        ...
        aoLightValueYPos = block.getAmbientOcclusionLightValue(blockAccess, i, j + 1, k);
        aoLightValueZPos = block.getAmbientOcclusionLightValue(blockAccess, i, j, k + 1);
        int i1 = block.getMixedBrightnessForBlock(blockAccess, i - 1, j, k);
        int j1 = block.getMixedBrightnessForBlock(blockAccess, i, j - 1, k);
        int k1 = block.getMixedBrightnessForBlock(blockAccess, i, j, k - 1);
        int l1 = block.getMixedBrightnessForBlock(blockAccess, i + 1, j, k);
        int i2 = block.getMixedBrightnessForBlock(blockAccess, i, j + 1, k);
        int j2 = block.getMixedBrightnessForBlock(blockAccess, i, j, k + 1);
        Tessellator tessellator = Tessellator.instance;
        tessellator.setBrightness(0xf000f);
        aoGrassXYZPPC = Block.canBlockGrass[blockAccess.getBlockId(i + 1, j + 1, k)];
        aoGrassXYZPNC = Block.canBlockGrass[blockAccess.getBlockId(i + 1, j - 1, k)];
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j - 1, k, 0))
        {
            ...
            colorGreenTopRight *= f25;
            colorBlueTopRight *= f25;
            renderBottomFace(block, i, j, k, l);
            flag = true;
        }
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j + 1, k, 1))
        {
    ...
    public boolean renderStandardBlockWithColorMultiplierByTextureId(Block block, int i, int j, int k, float f, float f1, float f2, 
            int l)
    {
        enableAO = false;
        Tessellator tessellator = Tessellator.instance;
        ...
        int i1 = block.getMixedBrightnessForBlock(blockAccess, i, j, k);
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j - 1, k, 0))
        {
            tessellator.setBrightness(block.minY > 0.0D ? i1 : block.getMixedBrightnessForBlock(blockAccess, i, j - 1, k));
            tessellator.setColorOpaque_F(f10, f13, f16);
            renderBottomFace(block, i, j, k, l);
            flag = true;
        }
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j + 1, k, 1))
        {
            tessellator.setBrightness(block.maxY < 1.0D ? i1 : block.getMixedBrightnessForBlock(blockAccess, i, j + 1, k));
            tessellator.setColorOpaque_F(f7, f8, f9);
            renderTopFace(block, i, j, k, l);
            flag = true;
        }
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k - 1, 2))
        {
            tessellator.setBrightness(block.minZ > 0.0D ? i1 : block.getMixedBrightnessForBlock(blockAccess, i, j, k - 1));
            tessellator.setColorOpaque_F(f11, f14, f17);
            int j1 = l;
            renderEastFace(block, i, j, k, j1);
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k + 1, 3))
        {
            tessellator.setBrightness(block.maxZ < 1.0D ? i1 : block.getMixedBrightnessForBlock(blockAccess, i, j, k + 1));
            tessellator.setColorOpaque_F(f11, f14, f17);
            int k1 = l;
            renderWestFace(block, i, j, k, k1);
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i - 1, j, k, 4))
        {
            tessellator.setBrightness(block.minX > 0.0D ? i1 : block.getMixedBrightnessForBlock(blockAccess, i - 1, j, k));
            tessellator.setColorOpaque_F(f12, f15, f18);
            int l1 = l;
            renderNorthFace(block, i, j, k, l1);
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i + 1, j, k, 5))
        {
            tessellator.setBrightness(block.maxX < 1.0D ? i1 : block.getMixedBrightnessForBlock(blockAccess, i + 1, j, k));
            tessellator.setColorOpaque_F(f12, f15, f18);
            int i2 = l;
            renderSouthFace(block, i, j, k, i2);
    ...
    public boolean renderBlockHerse(Block block, int i, int j, int k)
    {
        boolean flag = false;
        int l = blockAccess.getBlockMetadata(i, j, k);
        int i1 = blockAccess.getBlockId(i, j + 1, k);
        TileEntity tileentity = blockAccess.getBlockTileEntity(i, j + 1, k);
        if(l == 0 || l == 1)
        {
            block.setBlockBounds(0.45F, 0.0F, 0.2F, 0.55F, 1.0F, 0.3F);
            renderStandardBlock(block, i, j, k);
            ...
            block.setBlockBounds(0.475F, 0.225F, 0.8F, 0.525F, 0.275F, 1.0F);
            renderStandardBlock(block, i, j, k);
            if(i1 == 220 || i1 == 221 || i1 == 222)
            {
                block.setBlockBounds(0.475F, 0.95F, 0.0F, 0.525F, 1.0F, 0.2F);
                renderStandardBlock(block, i, j, k);
                block.setBlockBounds(0.475F, 0.95F, 0.3F, 0.525F, 1.0F, 0.7F);
                renderStandardBlock(block, i, j, k);
                block.setBlockBounds(0.475F, 0.95F, 0.8F, 0.525F, 1.0F, 1.0F);
                renderStandardBlock(block, i, j, k);
            } else
            {
                block.setBlockBounds(0.475F, 0.725F, 0.0F, 0.525F, 0.775F, 0.2F);
        ...
        if(l == 2 || l == 3)
        {
            block.setBlockBounds(0.2F, 0.0F, 0.45F, 0.3F, 1.0F, 0.55F);
            renderStandardBlock(block, i, j, k);
            block.setBlockBounds(0.7F, 0.0F, 0.45F, 0.8F, 1.0F, 0.55F);
            renderStandardBlock(block, i, j, k);
            block.setBlockBounds(0.0F, 0.225F, 0.475F, 0.2F, 0.275F, 0.525F);
            renderStandardBlock(block, i, j, k);
            block.setBlockBounds(0.3F, 0.225F, 0.475F, 0.7F, 0.275F, 0.525F);
            renderStandardBlock(block, i, j, k);
            block.setBlockBounds(0.8F, 0.225F, 0.475F, 1.0F, 0.275F, 0.525F);
            renderStandardBlock(block, i, j, k);
            if(i1 == 220 || i1 == 221 || i1 == 222)
            {
                block.setBlockBounds(0.0F, 0.95F, 0.475F, 0.2F, 1.0F, 0.525F);
                renderStandardBlock(block, i, j, k);
                block.setBlockBounds(0.3F, 0.95F, 0.475F, 0.7F, 1.0F, 0.525F);
                renderStandardBlock(block, i, j, k);
                block.setBlockBounds(0.8F, 0.95F, 0.475F, 1.0F, 1.0F, 0.525F);
                renderStandardBlock(block, i, j, k);
            } else
            {
                block.setBlockBounds(0.0F, 0.725F, 0.475F, 0.2F, 0.775F, 0.525F);
                renderStandardBlock(block, i, j, k);
                block.setBlockBounds(0.3F, 0.725F, 0.475F, 0.7F, 0.775F, 0.525F);
                renderStandardBlock(block, i, j, k);
                block.setBlockBounds(0.8F, 0.725F, 0.475F, 1.0F, 0.775F, 0.525F);
                renderStandardBlock(block, i, j, k);
            }
        }
        block.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
    ...
    public boolean renderBlockTonneau(Block block, int i, int j, int k)
    {
        boolean flag = false;
        int l = blockAccess.getBlockMetadata(i, j, k);
        block.setBlockBounds(0.05F, 0.0F, 0.05F, 0.95F, 1.0F, 0.15F);
        ...
        renderStandardBlock(block, i, j, k);
        block.setBlockBounds(0.0F, 0.6F, 0.05F, 0.05F, 0.75F, 0.95F);
        renderStandartByTextureId(block, i, j, k, 22);
        block.setBlockBounds(0.95F, 0.6F, 0.05F, 1.0F, 0.75F, 0.95F);
        renderStandartByTextureId(block, i, j, k, 22);
        block.setBlockBounds(0.0F, 0.6F, 0.0F, 1.0F, 0.75F, 0.05F);
        renderStandartByTextureId(block, i, j, k, 22);
    ...
    public boolean renderBlockCouverts(Block block, int i, int j, int k)
    {
        Tessellator tessellator = Tessellator.instance;
        int l = blockAccess.getBlockMetadata(i, j, k);
        ...
        double f8 = k + 1;
        double f9 = k + 0;
        double f10 = (double)j + f1;
        double f11 = (double)j + f1;
        double f12 = (double)j + f1;
        double f13 = (double)j + f1;
        //////////////
        if(l == 0)
        {
            f2 = f5 = i + 1;
    ...
    public boolean renderBlockChaine(Block block, int i, int j, int k)
    {
        boolean flag = false;
        double d = i;
        double d1 = j;
        double d2 = k;
        Tessellator tessellator = Tessellator.instance;
        int l = block.getBlockTextureFromSideAndMetadata(0, i);
        if(overrideBlockTexture >= 0)
        {
            l = overrideBlockTexture;
        }
        int i1 = (l & 0xf) << 4;
        int j1 = l & 0x1f0;
        double d3 = (float)i1 / 256F;
        double d4 = ((float)i1 + 15.99F) / 256F;
        double d5 = (float)j1 / 512F;
        double d6 = ((float)j1 + 15.99F) / 512F;
        ...
        j1 = l & 0x1f0;
        d3 = (float)i1 / 256F;
        d4 = ((float)i1 + 15.99F) / 256F;
        d5 = (float)j1 / 512F;
        d6 = ((float)j1 + 15.99F) / 512F;
        d7 = (d + 0.5D) - 0.44999998807907104D;
        d8 = d + 0.5D + 0.44999998807907104D;
        d9 = (d2 + 0.5D) - 0.44999998807907104D;
        d10 = d2 + 0.5D + 0.44999998807907104D;
        tessellator.addVertexWithUV(d7, d1 + 1.0D, d10, d3, d5);
        tessellator.addVertexWithUV(d7, d1 + 0.0D, d10, d3, d6);
        tessellator.addVertexWithUV(d8, d1 + 0.0D, d9, d4, d6);
        tessellator.addVertexWithUV(d8, d1 + 1.0D, d9, d4, d5);
    ...
    public boolean renderpanecolor(BlockPane blockpane, int i, int j, int k)
    {
        int l = blockAccess.getWorldHeight();
        Tessellator tessellator = Tessellator.instance;
        tessellator.setBrightness(blockpane.getMixedBrightnessForBlock(blockAccess, i, j, k));
    ...
    public boolean renderBlockArche(Block block, int i, int j, int k){
          boolean flag = false;
	      int i1 = blockAccess.getBlockMetadata(i, j, k);
	      if(i1 == 0)
	      {
    ...
    public boolean renderBlockMuret(Block block, int i, int j, int k){
		  MC_1BlockWall blockwall = (MC_1BlockWall)block;
	        float f = 0.3F;
	        float f1 = 0.7F;
	        float f2 = 0.0F;
	        float f3 = 0.8F;
	        ...
	        float f5 = 0.8F;
	        float f6 = 1.0F;
	        boolean flag = blockwall.isWallOrGateAt(blockAccess, i - 1, j, k);
	        boolean flag1 = blockwall.isWallOrGateAt(blockAccess, i + 1, j, k);
	        boolean flag2 = blockwall.isWallOrGateAt(blockAccess, i, j, k - 1);
	        boolean flag3 = blockwall.isWallOrGateAt(blockAccess, i, j, k + 1);
	        boolean flag4 = blockwall.isWallOrGateAt(blockAccess, i, j + 1, k);
	        boolean flag5 = blockwall.isWallOrGateAt(blockAccess, i, j - 1, k);
	        boolean flag6 = blockwall.isWallOrGateAt(blockAccess, i - 1, j + 1, k);
	        boolean flag7 = blockwall.isWallOrGateAt(blockAccess, i + 1, j + 1, k);
	        boolean flag8 = blockwall.isWallOrGateAt(blockAccess, i, j + 1, k - 1);
	        boolean flag9 = blockwall.isWallOrGateAt(blockAccess, i, j + 1, k + 1);
	        if(flag3 && flag2 && !flag1 && !flag && !flag4)
	        {
	            blockwall.setBlockBounds(f, f2, 0.0F, f1, f3, 1.0F);
	            renderStandardBlock(blockwall, i, j, k);
	        } else
	        if(flag1 && flag && !flag3 && !flag2 && !flag4)
	        {
	            blockwall.setBlockBounds(0.0F, f2, f, 1.0F, f3, f1);
	            renderStandardBlock(blockwall, i, j, k);
	        } else
	        if(flag4 && flag1 && flag && flag7 && flag6 && !flag9 && !flag8)
	        {
	            f3 = 1.0F;
	            blockwall.setBlockBounds(0.0F, f2, f, 1.0F, f3, f1);
	            renderStandardBlock(blockwall, i, j, k);
	        } else
	        if(flag4 && flag3 && flag2 && flag8 && flag9 && !flag7 && !flag6)
	        {
	            f3 = 1.0F;
	            blockwall.setBlockBounds(f, f2, 0.0F, f1, f3, 1.0F);
	            renderStandardBlock(blockwall, i, j, k);
	        ...
	        {
	            blockwall.setBlockBounds(f4, 0.0F, f4, f5, f6, f5);
	            renderStandardBlock(blockwall, i, j, k);
	            if(flag)
	            {
	                if(flag4 && flag6)
	                ...
	                blockwall.setBlockBounds(0.0F, f2, f, f1, f3, f1);
	                renderStandardBlock(blockwall, i, j, k);
	                f3 = 0.8F;
	            }
	            if(flag1)
	            {
	                ...
	                blockwall.setBlockBounds(f, f2, f, 1.0F, f3, f1);
	                renderStandardBlock(blockwall, i, j, k);
	                f3 = 0.8F;
	            }
	            if(flag3)
	            {
	                ...
	                blockwall.setBlockBounds(f, f2, f, f1, f3, 1.0F);
	                renderStandardBlock(blockwall, i, j, k);
	                f3 = 0.8F;
	            }
	            if(flag2)
	            {
	                ...
	                blockwall.setBlockBounds(f, f2, 0.0F, f1, f3, f1);
	                renderStandardBlock(blockwall, i, j, k);
	                f3 = 0.8F;
	            }
	        }
	        blockwall.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
	        return true;
    }

    public boolean renderBlockHoublon(Block block, int i, int j, int k)
    {
        Tessellator tessellator = Tessellator.instance;
        tessellator.setBrightness(block.getMixedBrightnessForBlock(blockAccess, i, j, k));
        float f = 1.0F;
        ...
        renderStandartByTextureId(block, i, j, k, 20);
        block.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
        return true;
    }
    
    public boolean renderBlockCoinStair(Block block, int i, int j, int k)
    {
        boolean flag = false;
        int l = blockAccess.getBlockId(i, j, k);
        if(blockAccess.getBlockMetadata(i, j, k) % 4 == 2 && blockAccess.getBlockId(i, j, k - 1) == l)
        {
            if(blockAccess.getBlockMetadata(i, j, k - 1) % 4 == 1)
            {
            ...
            if(blockAccess.getBlockMetadata(i, j, k - 1) % 4 == 0)
            {
        ...
        if(blockAccess.getBlockMetadata(i, j, k) % 4 == 3 && blockAccess.getBlockId(i, j, k + 1) == l)
        {
            if(blockAccess.getBlockMetadata(i, j, k + 1) % 4 == 1)
            {
                block.setBlockBounds(0.0F, 0.5F, 0.0F, 0.5F, 1.0F, 1.0F);
        ...
        if(blockAccess.getBlockMetadata(i, j, k) % 4 == 0 && blockAccess.getBlockId(i - 1, j, k) == l)
        {
            if(blockAccess.getBlockMetadata(i - 1, j, k) % 4 == 2)
            {
                block.setBlockBounds(0.0F, 0.5F, 0.5F, 0.5F, 1.0F, 1.0F);
                renderStandardBlock(block, i, j, k);
                block.setBlockBounds(0.5F, 0.5F, 0.0F, 1.0F, 1.0F, 1.0F);
            ...
            if(blockAccess.getBlockMetadata(i - 1, j, k) % 4 == 3)
            {
                block.setBlockBounds(0.0F, 0.5F, 0.0F, 0.5F, 1.0F, 0.5F);
                renderStandardBlock(block, i, j, k);
                block.setBlockBounds(0.5F, 0.5F, 0.0F, 1.0F, 1.0F, 1.0F);
        ...
        if(blockAccess.getBlockMetadata(i, j, k) % 4 == 1 && blockAccess.getBlockId(i + 1, j, k) == l)
        {
            if(blockAccess.getBlockMetadata(i + 1, j, k) % 4 == 2)
            {
                block.setBlockBounds(0.5F, 0.5F, 0.5F, 1.0F, 1.0F, 1.0F);
        ...
        block.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
        flag = renderBlockStairs(block, i, j, k);
        return flag;
    }
    
    public boolean renderBlockStairsCloth(Block block, int i, int j, int k)
    {
        boolean flag = false;
        int l = blockAccess.getBlockMetadata(i, j, k);
        int i1 = l % 4;
