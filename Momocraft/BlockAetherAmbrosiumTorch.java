...
public class BlockAetherAmbrosiumTorch extends Block{
	
	public BlockAetherAmbrosiumTorch(int i)
    {
        super(i, MomocraftTextures.TexBlockAetherAmbrosiumTorch, Material.circuits);
        setTickOnLoad(true);
    }
