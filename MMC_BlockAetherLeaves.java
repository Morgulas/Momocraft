...
public class MMC_BlockAetherLeaves extends BlockLeavesBase {
	public MMC_BlockAetherLeaves(int i)
    {
        super(i, i != MMC_ID.idBlockAetherGoldenOakLeaves ? sprSkyroot : sprGoldenOak, Material.leaves, false);
        setTickOnLoad(true);
    }

    public int quantityDropped(Random random)
    {
        if(blockID == MMC_Block.BlockAetherGoldenOakLeaves.blockID)
        {
    ...
    {
        if(blockID == MMC_Block.BlockAetherSkyrootLeaves.blockID)
        {
            return MMC_Block.BlockAetherSkyrootSapling.blockID;
        }
        ...
        {
            return MMC_Block.BlockAetherGoldenOakSapling.blockID;
        }
    }
...
*/
    ...
    public static int sprSkyroot = MMC_Textures.TexBlockAetherSkyrootLeaves;
    public static int sprGoldenOak = MMC_Textures.TexBlockAetherGoldenOakLeaves;
