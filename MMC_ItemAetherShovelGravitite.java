...
public class MMC_ItemAetherShovelGravitite extends ItemTool {

	public MMC_ItemAetherShovelGravitite(int i, EnumToolMaterial enumtoolmaterial)
    {
        ...
        if(movingobjectposition.typeOfHit == EnumMovingObjectType.TILE)
        {
            ...
            if(!world.multiplayerWorld)
            {
                ...
                for(int j1 = 0; j1 < blocksEffectiveAgainst.length; j1++)
                {
                    ...
                    if(l == MMC_Block.BlockAetherGrass.blockID)
                    {
                        l = MMC_Block.BlockAetherDirt.blockID;
                    }
