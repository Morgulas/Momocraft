...
public class MMC_GuiInventoryMoreSlots extends GuiContainer{
	
	public MMC_GuiInventoryMoreSlots(EntityPlayer entityplayer)
    {
...
//        field_948_f = true;
    ...
    {
        int i = mc.renderEngine.getTexture("/momocraft/aether/gui/inventory.png");
