...
public class AetherWorldGenLayerOceanReplacement extends GenLayer{
	
    public AetherWorldGenLayerOceanReplacement(long l, GenLayer genlayer)
    {
        super(l);
        parent = genlayer;
    }
    ...
    public int[] func_35500_a(int i, int j, int k, int l)
    {
        ...
        for(int i1 = 0; i1 < l; i1++)
        {
            for(int j1 = 0; j1 < k; j1++)
            {
                ...
                if(ai[j1 + i1 * k] == BiomeGenBase.ocean.biomeID)
                {
