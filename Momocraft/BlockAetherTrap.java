...
public class BlockAetherTrap extends BlockBreakable{
	
	public BlockAetherTrap(int i)
    {
...
*/
    ...
    public static int sprBronze = MomocraftTextures.TexBlockAetherCarvedStone;
    public static int sprSilver = MomocraftTextures.TexBlockAetherAngelicStone;
    public static int sprGold = MomocraftTextures.TexBlockAetherHellfireStone;
}
