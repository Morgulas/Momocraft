...
public class BlockAetherAercloud extends Block{
	
	public BlockAetherAercloud(int i)
    {
        super(i, MomocraftTextures.TexBlockAetherAercloud, Material.ice);
    }
    ...
    public void onEntityCollidedWithBlock(World world, int i, int j, int k, Entity entity)
    {
        ...
        if(world.getBlockMetadata(i, j, k) == 1)
        {
            ...
            {
                mod_Momocraft.giveAchievement(MomocraftAchievements.blueCloud, (EntityPlayer)entity);
            }
        } else
