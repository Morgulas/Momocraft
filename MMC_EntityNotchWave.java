...
public class MMC_EntityNotchWave extends Entity{
	 public MMC_EntityNotchWave(World world)
	    {
	        super(world);
	        xTileSnowball = -1;
	        yTileSnowball = -1;
	    ...
	    public MMC_EntityNotchWave(World world, EntityLiving entityliving)
	    {
	        super(world);
	        xTileSnowball = -1;
	        yTileSnowball = -1;
	    ...
	    public MMC_EntityNotchWave(World world, double d, double d1, double d2)
	    {
	        super(world);
	        xTileSnowball = -1;
	        yTileSnowball = -1;
...
//	                    entity1.attackEntityFrom(thrower, 5);
	        ...
	        if(movingobjectposition != null)
	        {
	            ...
	            {
//	                if(movingobjectposition.entityHit.attackEntityFrom(thrower, 1));
	    ...
	    private MMC_EntitySlider slider;
