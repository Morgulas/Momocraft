...
public class MomocraftAchievements {
	
	public MomocraftAchievements()
	    {
	        enterAether = (new Achievement(800, "enterAether", 0, 0, Block.glowStone, null)).registerAchievement();
	        defeatBronze = (new Achievement(801, "defeatBronze", -2, 3, new ItemStack(MomocraftItems.ItemAetherKey, 1, 0), enterAether)).registerAchievement();
	        defeatSilver = (new Achievement(802, "defeatSilver", 0, 4, new ItemStack(MomocraftItems.ItemAetherKey, 1, 1), enterAether)).registerAchievement();
	        defeatGold = (new Achievement(803, "defeatGold", 2, 3, new ItemStack(MomocraftItems.ItemAetherKey, 1, 2), enterAether)).registerAchievement();
	        ...
	        blueCloud = (new Achievement(806, "blueCloud", -2, -1, new ItemStack(MomocraftBlocks.BlockAetherAercloud, 1, 1), enterAether)).registerAchievement();
	        flyingPig = (new Achievement(807, "flyingPig", -2, 1, Item.saddle, enterAether)).registerAchievement();
	        gravTools = (new Achievement(808, "gravTools", -1, -3, MomocraftItems.ItemAetherPickGravitite, enterAether)).registerAchievement();
