...
public class AetherWorldGenLayerStream extends GenLayer {

	
	  public AetherWorldGenLayerStream(long l, GenLayer genlayer)
	    {
	        super(l);
	    ...
	    public int[] func_35500_a(int i, int j, int k, int l)
	    {
	        ...
	        for(int i2 = 0; i2 < l; i2++)
	        {
	            for(int j2 = 0; j2 < k; j2++)
	            {
	                ...
	                {
	                    ai1[j2 + i2 * k] = AetherWorldBiomeBase.stream.biomeID;
	                    continue;
	                }
